...
import { asisstantInstruction } from './personas/asisstantInstruction';
...
export const AIPersonas = [
   ...
   createModelConfig({
      ...
      instructions: asisstantInstruction.replace("{{{_AI_ASSISTANT_}}}", 'BabaAI Assistant'),
   }),
   createModelConfig({
